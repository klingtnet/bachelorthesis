\begin{tikzpicture}[
    ...
    \node(languageVisitor)[greyBlock, right=of languageModel]{Language-\\Visitor};
    \node(filePrinter)[greyBlock, right=of languageVisitor]{Ausgabemodul\\(File Printer)};
    ...
    \path[arrow, ->] (languageModel) -- (languageVisitor);
