...
\newglossaryentry{GPL}{
	name=GPL,
	description={
		\emph{General Purpose Language} bezeichnet eine Programmiersprache welche für die Entwicklung von Software aus einem großen Anwendungsbereich geeignet ist
	}
}
