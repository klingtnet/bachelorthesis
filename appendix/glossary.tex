...
\newglossaryentry{GPL}{
	...
	description={
		Eine \emph{General Purpose Language} bezeichnet eine Programmiersprache welche für den Einsatz in den verschiedensten Anwendungsbereichen verwendet kann, im Gegensatz zur einer \gls{DSL}, welche nur auf einen speziellen Bereich beschränkt ist.
	}
}
