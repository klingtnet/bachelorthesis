...
\begin{compactitem}
    ...
    \item[\ding{206}] Abbildungen der Methoden aus der Ressourcenbeschreibung. Methodenparameter, die zur Authentifizierung an der \gls{API} notwendig sind, werden durch einen Parameter der Klasse \textsc{ApiUser} (\cref{sec:api_auth}) substituiert \ding{207}.
\end{compactitem}
