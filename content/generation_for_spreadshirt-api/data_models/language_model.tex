...
Operatoren der Zielsprache müssen das Interface \textbf{Operator} implementieren, ein Operator ist durch seine Arität (Stelligkeit), Notation und sein Symbol gekennzeichnet. Zum Beispiel der Dereferenzierungsoperator in \textsc{Php} ist zweistellig, Infix notiert und wird gekennzeichnet durch das Symbol \texttt{->}.
